...
The data for this exercise comes from a different experiment with two factors.
...
priming_bf <- anovaBF(RT ~ Congruency*Load + Subject, data=priming, whichRandom = 'Subject')
priming_bf
