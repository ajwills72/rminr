...
```
In this brief extension worksheet, we look at why kappa is sometime much lower than percentage agreement, and also why the `kappa2` command sometimes prints `NaN` for _Z_ and _p_. 

To illustrate these things, here are some example rating, and the output they produce:
