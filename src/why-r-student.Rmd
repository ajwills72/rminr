...
[Jamovi][1] and [JASP][6] are also relatively new projects, with a low "bus number", while [R](https://en.wikipedia.org/wiki/R_(programming_language)) has
...
different answers to older versions (e.g. a change in which of two main effect is reported as
...
is obscured from the user by the use of a point and click interface, and causes problems for the repoducibility
