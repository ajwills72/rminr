...
This dataset has already undergone some preprocessing. We read the data, using `col_types` to explicitly define the types of data in each column. We set the first three columns as [factors](anova1.html#anovaWS) (the `fff`), and the remaining columns as integers (the `i`s).
