...
rely on p-value significance testing). Throughout your undergraduate course,
...
Most techniques were beyond an undergraduate course. Fortunately, you now have
the R coding and statistical skills to learn about it.
...
before data collection and not after. Estimating the power of your experiment
after data is collected and analysed, you will learn nothing that the Bayes
Factor or a p-value wouldn't tell you.
...
be important plan for that outcome as well.
...
analysis was first described by @kruschke2013bayesian.
@schonbrodt2018bayes adapts this algorithm to **fixed-n designs** with
**Bayes Factor**. In a fixed-n design, you test
...
On Psyc:EL, you will need to insert the code you used to
