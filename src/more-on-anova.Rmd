...
You'll also need to load the data, preprocess it, and set factors, as we did for Bayesian ANOVA. Here's how (**enter these commands into your script, and run them**):
...
Now, this is the command to run a traditional within-subjects ANOVA (**Enter this command into your script, and run iT**):
