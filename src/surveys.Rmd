...
Most of these software packages will allow you to save the survey data as a CSV file.
...
We'll also be using data from an experiment which explored mental imagery and self-esteem. This data was saved from SPSS. R can read SPSS `.sav` files into a data frame using the `read.spss()` function from the `foreign` package.
