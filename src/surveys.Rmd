...
FIXME <span style="color: red;">Agree and list pre-requisites</span>
...
**Explanation of command:** This is indentical to the previous pipeline, except that the post-intervention SSES data are in columns `26:45`, and these columns have the prefix `post_sse_` rather than `pre_sse_`.

<a name="reverse"></a>

# Reverse score survey

FIXME: Work in progress from this point onwards
