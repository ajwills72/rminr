...
2. Save [this CSV file](data/lineup.csv) into your RStudio project folder.
...
**Enter the Bayes Factor for question 6 into your lab book.**
...
Did participants think there view was better if they were told they made the correct decision? In this case, we have one ordered variable (`Q3`, their rating of their view on a 1-100 scale), and one unordered variable (`Cond` - whether they got feedback or not). 
...
**Record the mean viewing time for each condition, and the Bayes Factor for the difference, in your lab book**.
