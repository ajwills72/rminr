...
- `subj` : A number indicating which participant this datas comes from.
...
- `key` : The type of observation being made. Mostly, these are `GS` observations, which are _galvanic skin responses_. These are measures of level of arousal in the participant.
