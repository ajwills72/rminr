...
Like the Perruchet Effect experiment, the `r dplyr::count(panas)` rows in this data includes some duplicates. De-duplicate the data, and then  count the rows again. If you've done it right, the output should look like this:
