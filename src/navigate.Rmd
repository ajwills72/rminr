...
You'll need to complete the PsychEL excerise to get the CSV file containing the data. Set up an RStudio project for this analysis, and copy the CSV file into it. 
...
**Use RStudio to export your graph as an Image, and upload it to your lab book.** Any clear colour scheme, other than the yellow/black scheme used in this example, is fine. 
