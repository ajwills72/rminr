...
This first exercise uses techniques you learned previously, in order to revise concepts you'll need for the rest of this worksheet. If you need further revision, click on the links provided below.
