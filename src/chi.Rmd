...
**Enter the command for creating a _frequency table for culture_ into your script, and also into your lab book.**
...
_The coded friendship concepts occurred with different frequency across cultures, BF = 1.08 x 10<sup>8</sup>, X<sup>2</sup>(15) = 89.2, p < .001, see Table 1._
...
_Bayes Factors were calculated using the BayesFactor package (Morey & Rouder, 2018), within the R environment (R Core Team, 2021)._
