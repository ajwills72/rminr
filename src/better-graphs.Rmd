...
On a very early worksheet, we introduced the [histogram](#graphs) as a way of visualising a distribution. We can extend that plot by adding a curve 
...
oit %>% ggplot(aes(problems)) + 
  ...
  stat_function(fun = function(x) 
    dnorm(x, mean = mean(oit$problems), sd = sd(oit$problems)) * bw * n_obs) +
  xlim(0,7) +
