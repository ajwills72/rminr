...
* [Within-participants manipulations](#within)
    + [Single factor, ordered variable](#w-1x3)
    + [Interaction, two levels](#w-2x2)
* [Between-participants manipulations](#between)
    + [Single factor, two levels](#b-1x2)
    + [Single factor, unordered variable](#b-1x4)
