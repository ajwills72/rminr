...
A plot should visually describe patterns in data that would otherwise be difficult to communicate. The most appropriate plot will depend on the type of data you are working with, and the pattern you want to communicate. In practice, this often involves trying out different plots, and adjusting graphical elements before deciding how best to present your data.

As such, it's difficult to provide rules about how to plot your data. However, there are some principles which will help you to make this decision.
