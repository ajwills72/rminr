...
**Enter this command at the top of your your script, and run it:**
...
**Enter this command at the bottom of your script, and run it:**
...
**Add these commands to your script, and run them:**
...
Lines 1-2 set up the plot, with `subculture` on the x-axis and the difference score we previously calculated(`diff`) on the y-axis.
...
**Create a new R file called `pairs.R`, and enter the commands that follow into that file**:
