...
**RECORD YOUR ANSWER** - Type the exact mean income into your Data Exercise template (Word document
available from the DLE).
...
Now, export your histogram, using the _Export_ icon on RStudio's _Plots_ window, and selecting "Save as image...". Give it a meaningful file name (e.g. "ExploringIncomes") and click 'Save'. 
...
2. Find your file in that Downloads folder, and drag it to the appropriate part your Data Exercise template.
