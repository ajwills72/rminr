...
1. Type (or copy and paste) the command in the grey box below into the _script_ you have already created on RStudio (top left window, _exploring.R_).
...
1. Now ask RStudio to run this command. You do this by putting your cursor on the line of the script window containing the command, and pressing CTRL+ENTER (i.e. press the key marked 'Ctrl' and the RETURN or ENTER key together). Line 1 is automatically copied to your _Console_ window and run. 
...
**Copy the command in the grey box to line 2 of your script in RStudio and then press CTRL+ENTER to run it:** (don't forget to save your script)
...
**To calculate mean income in  R, add the following command to line 3 of your script and run it:**
