...
1. Type (or copy and paste) the command in the grey box below into the _script_ you have already created on RStudio (top left window, _exploring.R_). **Use line 2 of the script.** (Line 1 contains the comment you entered in the last worksheet).
...
1. Now ask RStudio to run this command. You do this by putting your cursor on the line of the script window containing the command, and pressing CTRL+ENTER (i.e. press the key marked 'Ctrl' and the RETURN or ENTER key together). The line is automatically copied to your _Console_ window and run. 
