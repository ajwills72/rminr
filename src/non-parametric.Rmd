...
We'll run a Mann-Whitney U test to see if there were any significant differences between scores for the Italian and English cards on the noun comprehension (`nc`) task.
