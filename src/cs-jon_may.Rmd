...
ocean.scales <- ocean %>%
   ...
   mutate(Openness=mean(c_across(o01:o10)),                        # compute the means of the ten items in each scale
          Conscientiousness=mean(c_across(o01:o10)),
          Extraversion=mean(c_across(o01:o10)),
          Agreeableness=mean(c_across(o01:o10)),
          Neuroticism=mean(c_across(o01:o10))) %>%                 # and then just keep the ID and five means
