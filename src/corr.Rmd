...
In this exercise, you'll apply what you've learned to the relationship between _ingroup closeness_, and _group-leader dominance_. Do each of the following analyses, and **include them in your report**. In order to get graphs from RStudio into your wordprocessor, follow [these instructions](insert-image.md).
...
- Describe the strength of the correlation (weak, moderate, or strong) using Cohen's conventions.

- Calculate the Bayes Factor for this correlation. 

- State the interpretation of the Bayes Factor, using one of the following terms: (a) substantial evidence for the presence of a relationship, (b) substantial evidence for the absence of the relationship, (c) equivocal evidence for the relationship. 
