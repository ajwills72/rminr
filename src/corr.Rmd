...
You'll be provided with a CSV file before or during the workshop. If you want to try out this worksheet without that data file, you can use this [example CSV file](data/corr.csv) instead. _You can only gain marks for this exercise if you use the CSV file from the workshop_.
