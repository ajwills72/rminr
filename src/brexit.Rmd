...
You'll need to complete the Psych:EL excerise to get the CSV files containing your data, and data for your group. [Open an RStudio project](intro-rstudio.html) for this analysis, within that create a script file for this analysis, and [upload the CSV files](entering-data-by-hand.html#upload) to the project.
