...
- [Comparing Italian and English cards using Mann-Whitney U tests](#mann-whitney)
- [Comparing Italian and English semantically related production errors](compare-production)
...
## Comparing Italian and English cards using Mann-Whitney U tests
...
## Comparing Italian and English semantically related production errors

NTS means non-target but semantically related e.g. the card was "house" but they said "hut".

* raincloud NTS ~ Production(NP/PP) * Card Language(E/I)
