...
Relevant worksheets: [Traditional non-parametric tests](non-parametric.html).

* Plot mean correct response ~ NC/NP * E/I with CI bars
* Plot mean correct response ~ PC/PP * E/I with CI bars

Now we look at the differences between scores for the Italian and English cards on each of the tests. In this study, this was done using a Mann-Whitney U test. We start by creating some the summary statistics which are used to interpret the Mann-Whitney U test.
