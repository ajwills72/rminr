...
In summary, `t = 3.67`, `df = 9991.3`, and `p = .0002`. Psychologists have a standard shorthand for this, which is to write, `t(991.3) = 3.67, p = .0002`. You'll see this sort of thing in most psychology articles. In more recent articles, you'll also see a report of the effect size, in this case `d = .020`, as we calculated previously.
