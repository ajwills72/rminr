...
Create a new RStudio project for this worksheet, download this [zip archive](rawdata.zip) of data to your computer, and then upload it to your RStudio project. Make sure it is the `rawdata.zip` file you upload (your computer might also produce a folder called `rawdata` - do not upload that). 
