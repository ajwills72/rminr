...
At this point, we have an table of Bayes Factors of the same form as Excercise 2. Row 1 is the
...
the results of two analyses - both called Bayesian ANOVAs - are not the same. You should not. 
