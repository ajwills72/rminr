...
This worksheet uses the same _git_ repository as the [preprocessing](preproc.html) and [within-subject differences](anova1.html) worksheets. Go back to your R project that contains this git repository now.
...
We can see that the curve for the `meditate` condition is approximately centred on zero. In other words, on average, there is no congruency effect after meditation training. 
