...
## Before you start...
Before starting this worksheet, you should have completed all three previous worksheets of the [Very Brief Guide to R](index.html). Once you'll have, you'll have an R project that contains a script like this:
...
One question we can ask about these data concerns the relationship between ingroup closeness and outgroup distants. 
...
As we covered in the [Evidence](evidence.html) worksheet, historically psychologists have typically reported _p values_, despite the fact that _p values_ are widely misinterpreted. If you want to calculate a _p value_ for a correlation co-efficient, you can use the following command:
...
If you're able to complete the above exercise on your own, you're all set! If not, ask for help in class, and/or work through the [Absolute Beginners' Guide to R](index.html)
