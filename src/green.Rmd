...
In this example, the graph tells a somewhat different story to the means. The two groups almost completely overlap.
...
In this example, the effect size is around 0.02, which is typically described as a very small ("negligible") effect. The effect size for your data may be different.
...
The Bayes Factor in this case is about 1/6, meaning it's about six times as likely there _isn't_ a difference as there is. Your number will likely be a bit different.
