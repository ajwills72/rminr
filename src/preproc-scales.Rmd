...
Our first step will be to remove columns from the raw survey data which aren't needed for data analysis.  We'll demonstrate this using some real data from the Depression Anxiety Stress Scales—21 (DASS-21, Henry & Crawford, 2005). The DASS-21 is a 21-item scale for measuring depression, anxiety and stress. This data is stored in the file `going-further/dass21.csv`.
