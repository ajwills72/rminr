...
1. Start a new script and call it **anova1ex.R**. Start your script with the command `rm(list=ls())`. This command clears your _Environment_ and so ensures your script is not relying on commands you have previously run. 
