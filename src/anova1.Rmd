...
In the [preprocessing](preproc.html) worksheet, you loaded data from a _git_ repository into an R project. Go back to that project now, and load this new  data set: 
...
Now we've given R this information about factors, we're ready to calculate a Bayes Factor for the difference between congruent and incongruent trials. To do this, we use the command:
