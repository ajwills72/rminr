...
- Start a new RStudio [project](using-projects.html#create) and open an [R script](using-projects.html#write) ready to record all your commands.
...
[Previously](group-differences.html), you learned that effect size measures how big the difference between two groups is, relative to the amount of variability within each group. For example, you worked out that the gender pay gap in the U.S. is several thousand dollars a year, and that the effect size is small, because both men and women vary a lot in how much they earn. The variability of incomes in the U.S. is high because there are a wide range of incomes above and below the mean.
...
That's the end of the revision. **Copy and paste the R script you used for this exercise into PsycEL.**
