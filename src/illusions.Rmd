...
2. Download your violin plot, using the _Export_ icon on RStudio's _Plots_ window, and selecting "Save as image...". Give it a meaninful file name (e.g. "illusion-violin") and click 'Save'. 

3. **Upload your violin plot** to PsycEL (see the PsychEL activity for instructions of how to do this).

4. Calculate the Bayes Factor for the comparison between 0 and 90 degrees for the T illusion. **Enter the exact Bayes Factor into the PsycEL answer section.**. 
