...
In this example, the participant under-esimated line length with the "arrow heads" (Angle > 90), and over-estimated line length with the "arrow tails" ( Angle < 90). Your data may be different.
