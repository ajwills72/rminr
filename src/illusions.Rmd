...
**Plymouth University students**: Create/open your project named `psyc413`; within that create a script file called `illusions.R`. Enter all commands into that script and run them from there.
