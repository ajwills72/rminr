...
Where there is no within-group variability, Cramer's Phi is 1. Let's illustrate this with a different contingency table, which we'll just generate here and now to illustrate:
...
Where there is no between-group variability, Cramer's Phi is zero. Here's an illustration with another new contingency table:
