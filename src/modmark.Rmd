...
5. Calculate the weighted sum of each of your marks, using the `sum` command, and then round to the nearest whole percentage, using the `round` command:

```{r mark}
round(sum(components * weights))
```

The number you get from the above command is your overal module mark. 
